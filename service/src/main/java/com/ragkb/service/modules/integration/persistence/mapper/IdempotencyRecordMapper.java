...
import com.ragkb.service.modules.integration.persistence.entity.IdempotencyRecord;
import org.apache.ibatis.annotations.Mapper;

/**
 * {@code idempotency_record} 表 Mapper —— MyBatis-Plus 骨架模板。
 *
 * <p>{@link BaseMapper} 已内置单表 CRUD 与分页（selectPage/selectById/insert/updateById/...）；
 * 复杂查询按需在 {@code resources/mapper/IdempotencyRecordMapper.xml} 写 XML，或在方法上加 {@code @Select}。
 *
