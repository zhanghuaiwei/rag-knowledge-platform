...
public class SearchChatController {
    ...
    public ApiResponse<PageData<ChatSession>> listChatSessions(
    ...
    public ApiResponse<CursorPageData<ChatMessage>> listChatMessages(
    ...
    public ApiResponse<ChatSession> archiveChatSession(@PathVariable long chatId) {
